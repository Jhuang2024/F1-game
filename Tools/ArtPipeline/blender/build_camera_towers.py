"""
build_camera_towers.py — thin wrapper: build build_camera_tower and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_camera_towers.py -- <repo_root>
"""
import sys, os
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_camera_towers", ob.name, stats["lod0_tris"],
