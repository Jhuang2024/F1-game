"""
build_light_towers.py — thin wrapper: build build_light_tower and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_light_towers.py -- <repo_root>
"""
import sys, os
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_light_towers", ob.name, stats["lod0_tris"],
