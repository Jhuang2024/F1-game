"""
build_grandstand_modules.py — thin wrapper: build build_grandstand and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_grandstand_modules.py -- <repo_root>
"""
import sys, os
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_grandstand_modules", ob.name, stats["lod0_tris"],
