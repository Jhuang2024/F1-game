"""
build_armco.py — thin wrapper: build build_armco and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_armco.py -- <repo_root>
"""
import sys, os
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_armco", ob.name, stats["lod0_tris"],
