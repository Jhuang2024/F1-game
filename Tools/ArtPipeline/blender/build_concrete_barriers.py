"""
build_concrete_barriers.py — thin wrapper: build build_concrete_barrier and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_concrete_barriers.py -- <repo_root>
"""
import sys, os
...
BUILDERS = ["build_concrete_barrier"]
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_concrete_barriers", ob.name, stats["lod0_tris"],
