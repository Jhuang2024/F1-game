"""
build_starting_gantry.py — thin wrapper: build build_start_gantry and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_starting_gantry.py -- <repo_root>
"""
import sys, os
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_starting_gantry", ob.name, stats["lod0_tris"],
