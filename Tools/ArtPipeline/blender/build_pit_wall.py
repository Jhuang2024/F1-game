"""
build_pit_wall.py — thin wrapper: build build_pit_wall and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_pit_wall.py -- <repo_root>
"""
import sys, os
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_pit_wall", ob.name, stats["lod0_tris"],
