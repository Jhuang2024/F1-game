"""
build_trackside_props.py — thin wrapper: build build_speaker_pole, build_ped_bridge, build_timing_gantry, build_guard_hut, build_utility_cabinet, build_maintenance_cart and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_trackside_props.py -- <repo_root>
"""
import sys, os
...
BUILDERS = ["build_speaker_pole", "build_ped_bridge", "build_timing_gantry", "build_guard_hut", "build_utility_cabinet", "build_maintenance_cart"]
FOLDER = "Props"
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_trackside_props", ob.name, stats["lod0_tris"],
