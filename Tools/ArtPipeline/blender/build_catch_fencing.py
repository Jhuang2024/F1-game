"""
build_catch_fencing.py — thin wrapper: build build_fence_post, build_catch_fence, build_fence_gate and export as game-ready GLB(s).
...
full-kit builds never diverge.
    ...
    <blender> --background --python build_catch_fencing.py -- <repo_root>
"""
import sys, os
...
BUILDERS = ["build_fence_post", "build_catch_fence", "build_fence_gate"]
FOLDER = "Track/Fencing"
...
def main():
    ...
    for fn_name in BUILDERS:
        ...
        print("[%s] %s LOD0=%d %s %s" % ("build_catch_fencing", ob.name, stats["lod0_tris"],
